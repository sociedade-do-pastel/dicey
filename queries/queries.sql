...
(3, 2, 1, 2, 30, 'agendada', 40.00, NULL),
...
(13, 2, 8, 1, 40, 'agendada', 52.80, NULL);
...
(1, 777777, 35912200733, 'Joelson'),
(2, 203290, 93999932999, 'João Afonso'),
(3, 322930, 82101282828, 'Uelinton'),
(4, 456456, 15641874654, 'Godofredo'),
(5, 196555, 15386667108, 'Washington'),
(6, 390709, 75991500341, 'Vanda'),
(7, 576854, 95274383382, 'Cosmo'),
(8, 508421, 62744905921, 'Jorjana');
